...
//  2018-11-14: Changed the signature of ImGui_SDL2_ProcessEvent() to take a 'const SDL_Event*'.
//  2018-08-01: Inputs: Workaround for Emscripten which doesn't seem to handle focus related calls.
//  2018-06-29: Inputs: Added support for the ImGuiMouseCursor_Hand cursor.
//  2018-06-08: Misc: Extracted imgui_impl_sdl.cpp/.h away from the old combined SDL2+OpenGL/Vulkan examples.
//  2018-06-08: Misc: ImGui_SDL2_InitForOpenGL() now takes a SDL_GLContext parameter.
...
static const char* ImGui_SDL2_GetClipboardText(void*)
{
...
static void ImGui_SDL2_SetClipboardText(void*, const char* text) { SDL_SetClipboardText(text); }
...
bool ImGui_SDL2_ProcessEvent(const SDL_Event* event)
{
...
static void ImGui_SDL2_UpdateMousePosAndButtons()
{
    ImGuiIO& io = ImGui::GetIO();
...
static void ImGui_SDL2_UpdateMouseCursor()
{
    ImGuiIO& io = ImGui::GetIO();
...
static void ImGui_SDL2_UpdateGamepads()
{
    ImGuiIO& io = ImGui::GetIO();
...
void ImGui_SDL2_NewFrame(float dt, float w, float h, float scaleX, float scaleY)
{
    ImGuiIO& io = ImGui::GetIO();
    IM_ASSERT(
        io.Fonts->IsBuilt() &&
    ...
    ImGui_SDL2_UpdateMousePosAndButtons();
    ImGui_SDL2_UpdateMouseCursor();

    // Update game controllers (if enabled and available)
    ImGui_SDL2_UpdateGamepads();
}
